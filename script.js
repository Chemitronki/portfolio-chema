...
function translateProject(card, lang, projectKey) {
    const projectTranslations = {
        en: {
            ...
            'ainativedevframework': { title: 'AI-NATIVE DEV FRAMEWORK', desc: 'TypeScript monorepo with CLI for AI-powered code analysis. 5 commands: analyze, suggest, refactor, fix-bugs and generate-feature. Includes AST, dependency graph and semantic embeddings.' },
            'ai-nativedevframework': { title: 'AI-NATIVE DEV FRAMEWORK', desc: 'TypeScript monorepo with CLI for AI-powered code analysis. 5 commands: analyze, suggest, refactor, fix-bugs and generate-feature. Includes AST, dependency graph and semantic embeddings.' },
            'superherolife': { title: 'SUPERHERO LIFE', desc: 'Gamified superhero training program comic-style. Mission system with quizzes, XP, levels, ranks and achievements.' },
        ...
        es: {
            ...
            'ainativedevframework': { title: 'AI-NATIVE DEV FRAMEWORK', desc: 'Monorepo TypeScript con CLI para análisis de código con IA. 5 comandos: analyze, suggest, refactor, fix-bugs y generate-feature.' },
            'ai-nativedevframework': { title: 'AI-NATIVE DEV FRAMEWORK', desc: 'Monorepo TypeScript con CLI para análisis de código con IA. 5 comandos: analyze, suggest, refactor, fix-bugs y generate-feature.' },
            'superherolife': { title: 'SUPERHERO LIFE', desc: 'Programa de entrenamiento de héroes gamificado estilo cómic. Misiones con quizzes, XP, niveles, rangos y logros.' },
